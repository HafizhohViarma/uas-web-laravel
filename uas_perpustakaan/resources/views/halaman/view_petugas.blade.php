...
@section('isihalaman')
   ...
   <div class="d-flex justify-content-center mt-3">
    <div>
        <span>Halaman : {{ $petugas->currentPage() }} </span>
        <span class="mx-2"> Jumlah Data : {{ $petugas->total() }} </span>
        <span> Data Per Halaman : {{ $petugas->perPage() }} </span>
    </div>
    </div>
                ...
                <div class="modal-body">
                    <form name="formpetugastambah" id="formpetugastambah" action="/petugas/tambah " method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="id_petugas" class="col-sm-4 col-form-label">Nama Petugas</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control text-dark" id="nama_petugas" name="nama_petugas" placeholder="Masukan Nama Petugas">
                            </div>
                        </div>
